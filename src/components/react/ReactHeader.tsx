...
const ReactHeader = ({ locale }: ReactHeaderProps) => {
  const t = useTranslator(locale as "en" | "ja");
  type lang = {
    langName: string,
    lang: string,
    flag: ReactElement,
  ...
  const langs: lang[] = [
    {
      langName: '日本語',
      lang: 'ja',
      flag: <JP className="flag-icon" style={{ width: '2em' }} />
    },
    {
      langName: 'English',
      lang: 'en',
      flag: <US className="flag-icon" style={{ width: '2em' }} />
    },
  ];
